...
fnt
 .get 'grat\grat.fnt',0,4096+46*8
 
 .put = {jmp start} , <start , >start	; JMP START
...
scr
 ins 'grat\grat.scr',120,12*40
 ins 'grat\grat.scr',120+12*40+40,4*40
...
init
	...
	icl 'grat\msx_cmc\playcmc.asm'

.endl

msx_address		dta a(music)
