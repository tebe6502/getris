...
*- msx+$1cf=tempo
*- msx+$1ce=pattern lenght

msx    equ $8f00
lenpat equ $20
speed  equ $03

zp   equ $e0  12 bytes on page 0
freq equ zp    4
slup equ zp+4  4
ad   equ zp+8  2
aud  equ zp+10 1
...
fin sta volume,x
 ...
 dec pozptr
 inc zegar
ret rts		;tu konczy dzialanie player
...
akce dta b(a1-ak),b(a0-ak),b(a2-ak)
 dta b(a4-ak),b(a5-ak),b(a6-ak),b(a8-ak)
typy dta b(s0-so),b(s1-so),b(s2-so),b(s3-so)
 dta b(s4-so),b(s5-so),b(s6-so),b(s7-so)
ndziel dta b($40),b(0),b($20),b(0)
